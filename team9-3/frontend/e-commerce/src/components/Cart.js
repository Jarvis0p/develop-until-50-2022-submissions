              ...
              <table class="table table-bordered m-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center align-middle py-3 px-0" style={{width: "40px"}}><Link to="#" class="shop-tooltip float-none text-light" title="" data-original-title="Clear cart"><i class="ino ion-md-trash"></i></Link></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <Link to="#" class="d-block text-dark">Product 1</Link>
                          <small>
                    ...
                    <td class="text-center align-middle px-0"><Link to="#" class="shop-tooltip close float-none text-danger" title="" data-original-title="Remove">×</Link></td>
                  </tr>
                  ...
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <Link to="#" class="d-block text-dark">Product 2</Link>
                          <small>
                            <span class="text-muted">Color:</span>
                  ...
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <Link to="#" class="d-block text-dark">Product 3</Link>
                          <small>
